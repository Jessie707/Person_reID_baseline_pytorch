...
parser.add_argument(
    "--train_all", action="store_true", help="use all training data"
)  # 可以利用
parser.add_argument(
    "--color_jitter", action="store_true", help="use color jitter in training"
)
parser.add_argument("--batchsize", default=32, type=int, help="batchsize")  # 可以修改
parser.add_argument(
    "--linear_num",
    default=512,
    type=int,
...
parser.add_argument(
    "--total_epoch", default=60, type=int, help="total training epoch"
)  # 可以修改
...
opt.nclasses = len(class_names)  # 不用修改类别数？
